...
// `pacman -Qei`; each block gives the name, version, install date, installed
// size and packager, which map onto the Name / Version / Installed On / Size /
// Publisher columns.
...
private:
    ...
    struct ProgramInfo {
        ...
        QString publisher;     // packager name, e.g. "CachyOS"
